...
QUESTIONS: List[Dict] = [
    # ===== CHAMPIONS =====
    {"q": "Who was the first ever Formula 1 World Champion?", "a": ["Nino Farina", "Giuseppe Farina", "Farina", "Giovanni Farina"]},
    ...
    {"q": "Who is the only driver to win the F1 championship on a motorcycle AND in F1?", "a": ["John Surtees", "Surtees"]},
    ...
    {"q": "What is the full name of the F1 team known as Mercedes?", "a": ["Mercedes-AMG Petronas", "Mercedes AMG Petronas", "Mercedes"]},
    ...
    {"q": "Force India was rebranded as which team?", "a": ["Racing Point", "Aston Martin"]},
    ...
    {"q": "How many race wins does Lewis Hamilton have (as of end of 2024)?", "a": ["104"]},
    ...
    {"q": "Which team was Kimi Raikkonen most associated with?", "a": ["Ferrari", "McLaren"]},
    {"q": "What is Kimi Raikkonen's famous nickname?", "a": ["The Iceman"]},
    {"q": "What is Sebastian Vettel's nickname?", "a": ["Baby Schumi", "The finger", "Seb"]},
    ...
    {"q": "Niki Lauda was Austrian and raced for which teams?", "a": ["Ferrari", "McLaren", "BRM"]},
    ...
    {"q": "Zhou Guanyu drives for which team?", "a": ["Sauber", "Stake", "Alfa Romeo"]},
    ...
    {"q": "Which driver famously said 'To whom it may concern' after winning a race?", "a": ["Max Verstappen", "Verstappen"]},
    ...
    {"q": "What was the horsepower figure of an F1 car with ground effect in the early 1980s?", "a": ["over 1000", "1000+", "1000hp", "1000 bhp"]},
    ...
    {"q": "Traction control was banned from F1 after which year?", "a": ["2008"]},
    ...
    {"q": "What colour tyre compound is the softest in modern F1?", "a": ["Red", "soft"]},
    {"q": "What colour tyre compound is medium in F1?", "a": ["Yellow", "medium"]},
    {"q": "What colour tyre compound is hard in F1?", "a": ["White", "hard"]},
    ...
    {"q": "The Lotus 49 was the first car to use which engine integration concept?", "a": ["stressed engine", "DFV"]},
    ...
    {"q": "Which team's car featured 'porpoising' issues in 2022 due to the new ground effect rules?", "a": ["Mercedes", "all teams", "everyone"]},
    ...
    {"q": "Which Red Bull driver parted ways with the team after the 2023 season?", "a": ["Sergio Perez", "Perez", "Checo"]},
    ...
    {"q": "McLaren won 8 Constructors titles — in which era did they peak?", "a": ["1980s", "late 1980s", "1988"]},
    ...
    {"q": "The F1 Hall of Fame is located in which country?", "a": ["UK", "United Kingdom", "England"]},
    {"q": "Which F1 driver has appeared on the most F1 championship points scoring occasions?", "a": ["Fernando Alonso", "Alonso"]},
    {"q": "Bernie Ecclestone ran the commercial side of F1 for how many decades?", "a": ["4", "four", "40 years"]},
    {"q": "Which team's car was called the 'Black Arrow'?", "a": ["Mercedes"]},
    {"q": "The checkered flag in F1 is also called?", "a": ["chequered flag"]},
    ...
    {"q": "Patrick Depailler drove for which teams in F1?", "a": ["Tyrrell", "Ligier"]},
    ...
    {"q": "The fastest F1 pit stop ever recorded was by Red Bull in 2019 — how fast was it?", "a": ["1.82 seconds", "under 2 seconds", "1.82"]},
    ...
    {"q": "Which driver replaced Daniel Ricciardo mid-2023 at AlphaTauri?", "a": ["Liam Lawson"]},
    {"q": "Liam Lawson is from which country?", "a": ["New Zealand"]},
    {"q": "Which famous F1 team did Jody Scheckter previously work for before Wolf Racing?", "a": ["Tyrrell"]},
    ...
    {"q": "Michael Schumacher was penalised at the 1994 British Grand Prix for ignoring which flag?", "a": ["black flag", "disqualification"]},
    ...
    # ===== FUN / TRIVIA =====
    {"q": "Which country has hosted the most F1 Grands Prix?", "a": ["Italy", "Great Britain", "UK"]},
    ...
    {"q": "Michael Schumacher holds the record for most wins at which circuit?", "a": ["Magny-Cours", "France", "Nurburgring"]},
    ...
    {"q": "Which F1 driver famously wore a rainbow flag helmet in 2021 to support LGBTQ+ rights?", "a": ["Lewis Hamilton", "Hamilton"]},
    ...
    {"q": "Which year did Lewis Hamilton have his first F1 race win?", "a": ["2007"]},
    ...
    {"q": "The Bahrain International Circuit has an alternate 'outer' layout used for what?", "a": ["testing", "preseason testing"]},
    {"q": "The Baku City Circuit is rated as having one of the longest straights in F1 — how long is it?", "a": ["2.2 km", "over 2 km", "2.2 kilometers"]},
    ...
    {"q": "The Spanish Grand Prix moved from the Circuit de Catalunya to which circuit (briefly)?", "a": ["Valencia", "Valencia Street Circuit"]},
    ...
    {"q": "George Russell won the 2024 Austrian Grand Prix — from which position did he start?", "a": ["1", "pole position", "P1"]},
    ...
    {"q": "Carlos Sainz won the 2024 Australian Grand Prix — was that Red Bull's dominant season?", "a": ["no", "no red bull had a tough race"]},
    ...
    {"q": "The wheel gun in an F1 pit stop operates at how many RPM?", "a": ["3000", "about 3000", "over 2000"]},
    ...
    {"q": "The Ferrari Driver Academy has produced which current F1 drivers?", "a": ["Charles Leclerc", "Leclerc", "Carlos Sainz"]},
    ...
    {"q": "Senna died before Prost retired — true or false?", "a": ["true"]},
    ...
    {"q": "After Schumacher's 7th title nobody thought the record would be broken — who broke it?", "a": ["Lewis Hamilton", "Hamilton"]},
